...
python run_experiment.py --pca --dataset2 --dim 2 --skiprerun --verbose --threads -1 > pca-dataset1-clustering.log 2>&1
...
python run_experiment.py --seed=10 --verbose --rp --dataset1 --dim 7 --skiprerun --verbose --threads 28